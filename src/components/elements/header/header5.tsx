        ...
        <div className="container">
          <div className="grid grid-cols-9 xl:grid-cols-4 gap-1 xl:gap-5 relative h-[90px] items-center">
            ...
            <div className="col-span-6 md:col-span-5 xl:col-span-1 flex justify-end gap-[10px]">
              ...
              >
                <a href="https://app.fledger.co.uk/login" className="btn-span" data-text="Login">
                  Login
                </a>
              </Button>
              <Button
                variant="primary"
                size="sm"
                className={cn(signUpBtnClassName, "bg-[#1B8475]")}
              >
                <a href="https://app.fledger.co.uk/SignUp" className="btn-span" data-text="Sign up">
                  Sign up
                </a>
              </Button>
